...
import parrhesia1000.ResourceBundleAwareLazyFxControllerAndViewResolver;
import parrhesia1000.Settings;
import parrhesia1000.SettingsProvider;
...
public class UiBeans {
    ...
    public UiBeans(UiConfig config) {
        this.config = config;
    }
